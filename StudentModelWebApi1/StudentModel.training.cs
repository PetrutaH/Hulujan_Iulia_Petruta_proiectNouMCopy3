...
using Microsoft.ML.Trainers;
    public partial class StudentModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"Hours Studied", @"Hours Studied"),new InputOutputColumnPair(@"Previous Scores", @"Previous Scores"),new InputOutputColumnPair(@"Sleep Hours", @"Sleep Hours"),new InputOutputColumnPair(@"Sample Question Papers Practiced", @"Sample Question Papers Practiced")})      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Hours Studied",@"Previous Scores",@"Sleep Hours",@"Sample Question Papers Practiced"}))      
                                    .Append(mlContext.Regression.Trainers.Sdca(new SdcaRegressionTrainer.Options(){L1Regularization=1F,L2Regularization=0.1F,LabelColumnName=@"Performance Index",FeatureColumnName=@"Features"}));
